...
%x=sin(t)+1/3*sin(3*t);
y=ammod(sin(2*pi*300*t+degtorad(90)),200e3,125e6);
plot(t,x,t,y)
grid on
...
fprintf(tcpipObj,'SOUR1:FREQ:FIX 1000e3');        % Set frequency of output signal
fprintf(tcpipObj,'SOUR2:FREQ:FIX 200e3');
